"""vendorfeedsed_20801 URL Configuration
...
admin.site.site_header = "Vendorfeedsed"
admin.site.site_title = "Vendorfeedsed Admin Portal"
admin.site.index_title = "Vendorfeedsed Admin"

# swagger
api_info = openapi.Info(
    title="Vendorfeedsed API",
    default_version="v1",
    description="API documentation for Vendorfeedsed App",
)
